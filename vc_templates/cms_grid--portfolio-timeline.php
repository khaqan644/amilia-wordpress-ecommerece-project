...
<div class="cms-grid-wraper portfolio-timeline-wrap blog-timeline-wrap <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="timeline-start">
        <div class="timeline-start-caption">
            <?php echo esc_attr($smof_data['portf_timeline_heading']); ?>
        </div>
    </div>
    <?php
        $posts = $atts['posts'];
        ...
        while($posts->have_posts()) {
            $posts->the_post();
            get_template_part( 'single-templates/timeline/content','content');
        }
    ?>
    <div class="timeline-start timeline-final">
        <div class="timeline-pagination cd-timeline-start-caption" data-text="<?php echo esc_attr($smof_data['portf_timeline_load']); ?>">
        </div>
    </div>
</div>