...
elseif (!empty($use_popup)) {
	$embed = '<a href="'.esc_url($link).'" class="cms-video-popup"><div class="video-img-thumb"><i class="icon_film" aria-hidden="true"></i><img src="'.esc_url($image_url).'" alt="Video"></div></a>';
