...
<div class="cms-grid-wraper cms-grid-pricing cms-grid-pricing-layout2 row" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="cms-grid <?php echo esc_attr($atts['grid_class']);?> cms-pricing-item-wrap">
        ...
        while($posts->have_posts()) {
            ...
            ?>
            <div class="cms-grid-item cms-grid-item-pricing <?php echo esc_attr($atts['item_class']);?> <?php echo esc_attr(( $pricing_meta->_cms_is_feature == 1 ) ? ' pricing-feature-item' : '' );?> pricing-horizontal clearfix">
				<div class="pricing-horizontal-content col-md-9">
					<div class="cms-custom-heading heading-line cms-h4">
						<h4 class="cms-pricing-title <?php echo esc_attr(( $pricing_meta->_cms_is_feature == 1 ) ? ' pr-feature' : ''); ?>"><?php the_title();?></h4>
					</div>
