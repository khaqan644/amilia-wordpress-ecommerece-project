    ...
    <li data-menuanchor="" id="menu-item-<?php echo ''.$item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo ''.$item_id; ?>">
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo ''.$key . '-' . $item_id; ?>">
                    <select id="edit-<?php echo ''.$key . '-' . $item_id; ?>" class=" <?php echo ''.$key; ?>" name="<?php echo ''.$key . "[" . $item_id . "]"; ?>">
                        <option value="standard" <?php echo esc_attr(( $value == 'standard' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Standard Dropdown', 'wp-amilia' ); ?></option>
                        <option value="columns2" <?php echo esc_attr(( $value == 'columns2' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( '2 columns dropdown', 'wp-amilia' ); ?></option>
                        <option value="columns3" <?php echo esc_attr(( $value == 'columns3' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( '3 columns dropdown', 'wp-amilia' ); ?>
                        </option>
                        <option value="columns4" <?php echo esc_attr(( $value == 'columns4' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( '4 columns dropdown', 'wp-amilia' ); ?></option>
                        <option value="columns5" <?php echo esc_attr(( $value == 'columns5' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( '5 columns dropdown', 'wp-amilia' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                    <select id="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class=" <?php echo esc_attr(''.$key); ?>" name="<?php echo esc_attr(''.$key . "[" . $item_id . "]"); ?>">
                        <option value="autodrop_submenu" <?php echo esc_attr(( $value == 'autodrop_submenu' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Auto drop', 'wp-amilia' ); ?></option>
                        <option value="drop_to_left" <?php echo esc_attr(( $value == 'drop_to_left' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Drop To Left Side', 'wp-amilia' ); ?></option>
                        <option value="drop_to_right" <?php echo esc_attr(( $value == 'drop_to_right' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Drop To Right Side', 'wp-amilia' ); ?></option>
                        <option value="drop_to_center" <?php echo esc_attr(( $value == 'drop_to_center' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Drop To Center', 'wp-amilia' ); ?></option>
                        <option value="drop_full_width" <?php echo esc_attr(( $value == 'drop_full_width' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Full width', 'wp-amilia' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            ...
            <p class="description description-wide description_width_100 el_widget_area">
                ...
                <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                    <select id="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class=" <?php echo esc_attr(''.$key); ?>" name="<?php echo esc_attr(''.$key . "[" . $item_id . "]"); ?>">
                        <option value="" <?php echo esc_attr(( $value == '' ) ? ' selected="selected" ' : ''); ?>><?php _e( 'Select Widget Area', 'wp-amilia' ); ?></option>
                        <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                    <select id="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class=" <?php echo esc_attr(''.$key); ?>" name="<?php echo esc_attr(''.$key . "[" . $item_id . "]"); ?>">
                        <option value="no_group" <?php echo esc_attr(( $value == 'no_group' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'No', 'wp-amilia' ); ?></option>
                        <option value="group" <?php echo esc_attr(( $value == 'group' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Yes', 'wp-amilia' ); ?></option>
                    </select>
                </label>
            </p>
            <?php
            ...
            <p class="description description-wide description_width_100">
                ...
                <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                    <select id="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class=" <?php echo esc_attr(''.$key); ?>" name="<?php echo esc_attr(''.$key . "[" . $item_id . "]"); ?>">
                        <option value="0" <?php echo esc_attr(( $value == '0' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'No', 'wp-amilia' ); ?></option>
                        <option value="1" <?php echo esc_attr(( $value == '1' ) ? ' selected="selected" ' : ''); ?>><?php esc_html_e( 'Yes', 'wp-amilia' ); ?></option>
                    </select>
                </label>
            </p>
        <?php }
        ...
        <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d1">
            <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                ...
                <input alt="#TB_inline?height=400&width=500&inlineId=<?php echo esc_attr(''.$key . '-' . $item_id . '-popup'); ?>" title="<?php esc_html_e( 'Click to browse icon', 'wp-amilia' ) ?>" class="thickbox button-secondary submit-add-to-menu" type="button" value="<?php esc_html_e( 'Browse Icon', 'wp-amilia' ) ?>" />
            ...
            <p class="description description-wide obtheme_checkbox obtheme_mega_menu obtheme_mega_menu_d2">
                <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                    <span class='obtheme_long_desc'><?php echo esc_html( $title ); ?></span><br />
                    <input type="text" value="<?php echo esc_attr(''.$value); ?>" id="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class=" <?php echo esc_attr(''.$key); ?>" name="<?php echo esc_attr(''.$key . "[" . $item_id . "]"); ?>" />
                    <button id="browse-edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class="set_custom_images button button-secondary submit-add-to-menu"><?php esc_html_e( 'Browse Image', 'wp-amilia' ); ?></button>
                    <a class="button btn_clear button-primary" href="javascript: void(0);">Clear</a>
                </label>
            </p>
                ...
                <label for="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>">
                    <select id="edit-<?php echo esc_attr(''.$key . '-' . $item_id); ?>" class=" <?php echo esc_attr(''.$key); ?>" name="<?php echo esc_attr(''.$key . "[" . $item_id . "]"); ?>">
                        ...
                        foreach ( $options as $option ) {
                            ?>
                            <option value="<?php echo esc_attr(''.$option); ?>" <?php echo esc_attr(( $value == $option ) ? ' selected="selected" ' : ''); ?>><?php echo esc_attr(''.$option); ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="menu-item-actions description-wide submitbox">
                ...
                ); ?>"><?php _e('Remove','wp-amilia'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr(''.$item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                    ?>#menu-item-settings-<?php echo esc_attr(''.$item_id); ?>"><?php esc_html_e('Cancel','wp-amilia'); ?></a>
            </div>
